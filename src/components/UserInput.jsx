...
function UserInput({ onChangeInput, userInput }) {
  return (
    <section className="w-full font-poppins h-auto sm:w-8/12 md:text-lg mx-auto  p-10 flex justify-center items-center bg-gradient-to-bl from-emerald-200 to-emerald-500">
